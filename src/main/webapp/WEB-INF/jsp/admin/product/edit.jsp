    ...
    <table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee"
        ...
        <tr>
            ...
            <td class="ta_01" bgColor="#ffffff">
                <input type="text" name="pname" value="<c:out value="${product.pname }"/>"
        ...
        <tr>
            ...
            <td class="ta_01" bgColor="#ffffff">
                <input type="text" name="market_price" value="<c:out value="${product.market_price }"/>"
                       id="userAction_save_do_logonName" class="bg"/>
            </td>
            <td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
                商城价格：
            ...
            <td class="ta_01" bgColor="#ffffff">
                <input type="text" name="shop_price" value="<c:out value="${product.shop_price }"/>"
                       id="userAction_save_do_logonName" class="bg"/>
            </td>
        </tr>
        <tr>
            ...
            <td class="ta_01" bgColor="#ffffff">
                <input type="text" name="inventory" id="inventory" value="<c:out value="${product.inventory }"/>"
                       id="userAction_save_do_logonName" class="bg"/>
