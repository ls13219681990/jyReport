    ...
    <table cellSpacing="1" cellPadding="5" width="100%" align="center"
        ...
        <tr>
            ...
            <td class="ta_01" bgColor="#ffffff"><form:input type="text"
                                                            path="username" id="userAction_save_do_logonName"
                                                            cssClass="bg"/></td>
            <td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
                密码：
            </td>
            <td class="ta_01" bgColor="#ffffff"><form:input type="password"
                                                            path="password" id="userAction_save_do_logonName"
                                                            cssClass="bg"/></td>
        </tr>
        <tr>
            <td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
            ...
            <td class="ta_01" bgColor="#ffffff"><form:input type="text"
                                                            path="name" id="userAction_save_do_logonName"
                                                            cssClass="bg"/></td>
            <td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
                邮箱：
            </td>
            <td class="ta_01" bgColor="#ffffff"><form:input type="text"
                                                            path="email" id="userAction_save_do_logonName"
                                                            cssClass="bg"/></td>
        </tr>
        <tr>
            <td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
            ...
            <td class="ta_01" bgColor="#ffffff"><form:input type="text"
                                                            path="phone" id="userAction_save_do_logonName"
                                                            cssClass="bg"/></td>
            <td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
                地址：
            </td>
            <td class="ta_01" bgColor="#ffffff"><form:input type="text"
                                                            path="addr" id="userAction_save_do_logonName"
                                                            cssClass="bg"/></td>
        </tr>
