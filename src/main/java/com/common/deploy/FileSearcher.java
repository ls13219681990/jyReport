...
public class FileSearcher {
    ...
    public static void findFiles(String baseDirName, String targetFileName,
        ...
        if (!baseDir.exists() || !baseDir.isDirectory()) {
            throw new BusinessException("文件查找失败： " + baseDirName);
//			System.out.println("文件查找失败：" + baseDirName + "不是一个目录！");
    ...
    public static void main(String[] paramert) {
        // 在此目录中找文件
        String baseDIR = "D:/apache-tomcat-7.0.29/webapps/booking/WEB-INF/classes/dao/comm/baseTranRec";
        // 找扩展名为txt的文件
        String fileName = "BaseTranRecDaoImpl$?.class";
